...
public class KnightContainer extends BaseContainer
{
    public KnightContainer(int windowId, BlockPos position, Inventory playerInventory, Player player)
    {
        super(Registration.KNIGHT_CONTAINER, Registration.KNIGHT, windowId, position, playerInventory, player);
    }
