...
public class PawnContainer extends BaseContainer
{
    public PawnContainer(int windowId, BlockPos position, Inventory playerInventory, Player player)
    {
        super(Registration.PAWN_CONTAINER, Registration.PAWN, windowId, position, playerInventory, player);
    }
