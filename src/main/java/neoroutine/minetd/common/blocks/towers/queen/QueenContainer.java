...
public class QueenContainer extends BaseContainer
{
    public QueenContainer(int windowId, BlockPos position, Inventory playerInventory, Player player)
    {
        super(Registration.QUEEN_CONTAINER, Registration.QUEEN, windowId, position, playerInventory, player);
    }
