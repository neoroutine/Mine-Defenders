...
public class SoftGeneratorScreen extends BaseContainerScreen<SoftGeneratorContainer>
{
        public SoftGeneratorScreen(SoftGeneratorContainer container, Inventory inv, Component name)
        {
