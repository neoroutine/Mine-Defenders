...
public class MiniGeneratorContainer extends BaseContainer
{
    public MiniGeneratorContainer(int windowId, BlockPos position, Inventory playerInventory, Player player)
    {
        super(Registration.MINIGENERATOR_CONTAINER, Registration.MINIGENERATOR, windowId, position, playerInventory, player);
