...
public class NeutronGeneratorContainer extends BaseContainer
{
    public NeutronGeneratorContainer(int windowId, BlockPos position, Inventory playerInventory, Player player)
    {
        super(Registration.NEUTRON_GENERATOR_CONTAINER, Registration.NEUTRON_GENERATOR, windowId, position, playerInventory, player);
