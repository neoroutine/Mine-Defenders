...
public class SoftGeneratorContainer extends BaseContainer
{
    public SoftGeneratorContainer(int windowId, BlockPos position, Inventory playerInventory, Player player)
    {
        super(Registration.SOFT_GENERATOR_CONTAINER, Registration.SOFT_GENERATOR, windowId, position, playerInventory, player);
