...
public class BlackKingContainer extends BaseContainer
{
    public BlackKingContainer(int windowId, BlockPos position, Inventory playerInventory, Player player)
    {
        super(Registration.BLACK_KING_CONTAINER, Registration.BLACK_KING, windowId, position, playerInventory, player);
    }
